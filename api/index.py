...
# In-memory mock storage for Vercel Serverless demo
SAMPLE_DOCUMENTS = [
    {
        "id": "doc-vtu-001",
        "document_name": "2ND SEM RESULT.pdf",
        "file_path": "backend/data/uploads/2ND SEM RESULT.pdf",
        "upload_timestamp": "2024-08-16T10:00:00Z",
        "file_size_bytes": 40641,
        "total_pages": 1,
        "chunk_count": 3,
        "status": "ACTIVE"
    }
